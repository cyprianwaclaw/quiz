...
//        'base_url' => null,
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your token by call request to <b><a href="#auth-POST-login">/login</a></b>.',
    ],
    ...
    'intro_text' => <<<INTRO
Dokumentacjia API
<aside><strong>Update 10.05.2022</strong>
Added pagination for list of quizzes<br>
Please read the documentation and see the repsponse <a href="#quizzes-GET-quizzes">here</a>.
</aside>
INTRO
    ,
   /* 'intro_text' => <<<INTRO
...
//        'javascript',
    ...
    'strategies' => [
        'metadata' => [
            ...
            App\Docs\Strategies\ChangeEndpointUri::class,
        ],
        'urlParameters' => [
