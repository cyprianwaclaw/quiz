...
class CheckCompetitionResults extends Command
{
    ...
    public function handle()
    {
        ...
        Log::info('Rozpoczęto sprawdzanie wyników konkursów', [
        ...
        Log::info('Zakończono sprawdzanie wyników konkursów');
    }

    protected function checkCompetitionResults(Competition $competition)
    {
        Log::info('Rozpoczęto sprawdzanie wyników konkursu', [
            'competition_id' => $competition->id,
            'competition_time' => $competition->time_end,
        ]);
        ...
        foreach ($competitionSubmissions as $submission) {
            ...
            if ($user) {
                ...
                Log::info('Zaktualizowano punkty użytkownika', [
                    'user_id' => $user->id,
            ...
            if ($competitionSubmission) {
                ...
                Log::info('Zaktualizowano miejsce w zgłoszeniu konkursowym', [
                    'submission_id' => $submission->id,
                    'new_place' => $submission->place,
                ]);
            }
        }

        Log::info('Zakończono przetwarzanie wyników konkursu', [
            'competition_id' => $competition->id,
            'total_submissions' => $competitionSubmissions->count(),
        ]);
    }
}